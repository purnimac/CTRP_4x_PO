    ...
    extends Correlation
{
    ...
    public HealthCareFacility withPlayerIdentifier(II value) {
        setPlayerIdentifier(value);
        return this;
    }

    public HealthCareFacility withStatus(CD value) {
        setStatus(value);
        return this;
    }

    public HealthCareFacility withPostalAddress(DSETAD value) {
        setPostalAddress(value);
        return this;
    }

    public HealthCareFacility withTelecomAddress(DSETTEL value) {
        setTelecomAddress(value);
        return this;
    }

    public HealthCareFacility withName(ENON value) {
        setName(value);
        return this;
    }

    @Override
    public HealthCareFacility withIdentifier(DSETII value) {
        setIdentifier(value);
        return this;
    }
