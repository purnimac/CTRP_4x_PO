    ...
    extends Correlation
{
    ...
    public OrganizationalContact withPlayerIdentifier(II value) {
        setPlayerIdentifier(value);
        return this;
    }

    public OrganizationalContact withScoperIdentifier(II value) {
        setScoperIdentifier(value);
        return this;
    }

    public OrganizationalContact withPostalAddress(DSETAD value) {
        setPostalAddress(value);
        return this;
    }

    public OrganizationalContact withTelecomAddress(DSETTEL value) {
        setTelecomAddress(value);
        return this;
    }

    public OrganizationalContact withStatus(CD value) {
        setStatus(value);
        return this;
    }

    public OrganizationalContact withTypeCode(CD value) {
        setTypeCode(value);
        return this;
    }

    public OrganizationalContact withTitle(ST value) {
        setTitle(value);
        return this;
    }

    @Override
    public OrganizationalContact withIdentifier(DSETII value) {
        setIdentifier(value);
        return this;
    }
