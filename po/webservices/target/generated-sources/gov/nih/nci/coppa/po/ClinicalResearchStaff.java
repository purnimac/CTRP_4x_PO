...
@XmlRootElement(name = "ClinicalResearchStaff")
    ...
    extends Correlation
{
    ...
    public ClinicalResearchStaff withPlayerIdentifier(II value) {
        setPlayerIdentifier(value);
        return this;
    }

    public ClinicalResearchStaff withScoperIdentifier(II value) {
        setScoperIdentifier(value);
        return this;
    }

    public ClinicalResearchStaff withPostalAddress(DSETAD value) {
        setPostalAddress(value);
        return this;
    }

    public ClinicalResearchStaff withTelecomAddress(DSETTEL value) {
        setTelecomAddress(value);
        return this;
    }

    public ClinicalResearchStaff withStatus(CD value) {
        setStatus(value);
        return this;
    }

    @Override
    public ClinicalResearchStaff withIdentifier(DSETII value) {
        setIdentifier(value);
        return this;
    }
