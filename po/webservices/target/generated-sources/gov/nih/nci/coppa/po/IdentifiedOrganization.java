...
@XmlRootElement(name = "IdentifiedOrganization")
public class IdentifiedOrganization
    extends Correlation
{
    ...
    public IdentifiedOrganization withPlayerIdentifier(II value) {
        setPlayerIdentifier(value);
        return this;
    }

    public IdentifiedOrganization withScoperIdentifier(II value) {
        setScoperIdentifier(value);
        return this;
    }

    public IdentifiedOrganization withAssignedId(II value) {
        setAssignedId(value);
        return this;
    }

    public IdentifiedOrganization withStatus(CD value) {
        setStatus(value);
        return this;
    }

    @Override
    public IdentifiedOrganization withIdentifier(DSETII value) {
        setIdentifier(value);
        return this;
    }
