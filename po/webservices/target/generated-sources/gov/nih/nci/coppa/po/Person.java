    ...
    extends Entity
{
    ...
    public Person withName(ENPN value) {
        setName(value);
        return this;
    }

    public Person withPostalAddress(AD value) {
        setPostalAddress(value);
        return this;
    }

    public Person withStatusCode(CD value) {
        setStatusCode(value);
        return this;
    }

    public Person withTelecomAddress(DSETTEL value) {
        setTelecomAddress(value);
        return this;
    }

    public Person withRaceCode(DSETCD value) {
        setRaceCode(value);
        return this;
    }

    public Person withSexCode(CD value) {
        setSexCode(value);
        return this;
    }

    public Person withEthnicGroupCode(DSETCD value) {
        setEthnicGroupCode(value);
        return this;
    }

    public Person withBirthDate(TS value) {
        setBirthDate(value);
        return this;
    }

    @Override
    public Person withIdentifier(II value) {
        setIdentifier(value);
        return this;
    }
