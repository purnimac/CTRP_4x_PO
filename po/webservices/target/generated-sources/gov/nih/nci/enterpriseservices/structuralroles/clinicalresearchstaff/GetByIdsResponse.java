...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withClinicalResearchStaff(ClinicalResearchStaff... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withClinicalResearchStaff(Collection<ClinicalResearchStaff> values) {
        if (values!= null) {
