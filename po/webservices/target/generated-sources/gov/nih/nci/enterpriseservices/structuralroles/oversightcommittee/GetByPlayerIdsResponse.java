...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withOversightCommittee(OversightCommittee... values) {
        if (values!= null) {
    ...
    public GetByPlayerIdsResponse withOversightCommittee(Collection<OversightCommittee> values) {
        if (values!= null) {
