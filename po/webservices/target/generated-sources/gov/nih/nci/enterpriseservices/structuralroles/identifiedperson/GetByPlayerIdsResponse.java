...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withIdentifiedPerson(IdentifiedPerson... values) {
        if (values!= null) {
    ...
    public GetByPlayerIdsResponse withIdentifiedPerson(Collection<IdentifiedPerson> values) {
        if (values!= null) {
