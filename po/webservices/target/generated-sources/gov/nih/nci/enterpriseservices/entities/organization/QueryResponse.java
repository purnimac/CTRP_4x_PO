...
public class QueryResponse {
    ...
    public QueryResponse withOrganization(Organization... values) {
        if (values!= null) {
            for (Organization value: values) {
                getOrganization().add(value);
            }
        }
        return this;
    }

    public QueryResponse withOrganization(Collection<Organization> values) {
        if (values!= null) {
            getOrganization().addAll(values);
        }
        return this;
    }
