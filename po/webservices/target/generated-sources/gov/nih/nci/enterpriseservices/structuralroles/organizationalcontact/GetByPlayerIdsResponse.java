...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withOrganizationalContact(OrganizationalContact... values) {
        if (values!= null) {
    ...
    public GetByPlayerIdsResponse withOrganizationalContact(Collection<OrganizationalContact> values) {
        if (values!= null) {
