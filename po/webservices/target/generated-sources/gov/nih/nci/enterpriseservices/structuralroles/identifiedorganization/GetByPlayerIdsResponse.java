...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withIdentifiedOrganization(IdentifiedOrganization... values) {
        if (values!= null) {
    ...
    public GetByPlayerIdsResponse withIdentifiedOrganization(Collection<IdentifiedOrganization> values) {
        if (values!= null) {
