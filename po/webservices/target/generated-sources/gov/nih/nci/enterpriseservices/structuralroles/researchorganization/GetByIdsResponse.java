...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withResearchOrganization(ResearchOrganization... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withResearchOrganization(Collection<ResearchOrganization> values) {
        if (values!= null) {
