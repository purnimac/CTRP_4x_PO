...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withOrganizationalContact(OrganizationalContact... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withOrganizationalContact(Collection<OrganizationalContact> values) {
        if (values!= null) {
