...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withHealthCareFacility(HealthCareFacility... values) {
        if (values!= null) {
    ...
    public GetByPlayerIdsResponse withHealthCareFacility(Collection<HealthCareFacility> values) {
        if (values!= null) {
