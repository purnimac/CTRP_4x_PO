...
public class QueryResponse {
    ...
    public QueryResponse withClinicalResearchStaff(ClinicalResearchStaff... values) {
        if (values!= null) {
    ...
    public QueryResponse withClinicalResearchStaff(Collection<ClinicalResearchStaff> values) {
        if (values!= null) {
