...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withIdentifiedOrganization(IdentifiedOrganization... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withIdentifiedOrganization(Collection<IdentifiedOrganization> values) {
        if (values!= null) {
