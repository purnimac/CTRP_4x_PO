...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withHealthCareProvider(HealthCareProvider... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withHealthCareProvider(Collection<HealthCareProvider> values) {
        if (values!= null) {
