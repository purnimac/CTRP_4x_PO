...
public class QueryResponse {
    ...
    public QueryResponse withResearchOrganization(ResearchOrganization... values) {
        if (values!= null) {
    ...
    public QueryResponse withResearchOrganization(Collection<ResearchOrganization> values) {
        if (values!= null) {
