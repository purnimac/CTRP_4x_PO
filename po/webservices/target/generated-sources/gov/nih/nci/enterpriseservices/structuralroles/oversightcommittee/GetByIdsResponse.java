...
public class GetByIdsResponse {
    ...
    public GetByIdsResponse withOversightCommittee(OversightCommittee... values) {
        if (values!= null) {
    ...
    public GetByIdsResponse withOversightCommittee(Collection<OversightCommittee> values) {
        if (values!= null) {
