...
public class GetByPlayerIdsResponse {
    ...
    public GetByPlayerIdsResponse withResearchOrganization(ResearchOrganization... values) {
        if (values!= null) {
            for (ResearchOrganization value: values) {
                getResearchOrganization().add(value);
            }
        }
        return this;
    }

    public GetByPlayerIdsResponse withResearchOrganization(Collection<ResearchOrganization> values) {
        if (values!= null) {
            getResearchOrganization().addAll(values);
        }
        return this;
    }
