...
public class Tfoot {
    ...
    public Tfoot withTr(Collection<Tr> values) {
        if (values!= null) {
            getTr().addAll(values);
        }
        return this;
    ...
    public Tfoot withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Tfoot withStyleCode(Collection<String> values) {
        if (values!= null) {
