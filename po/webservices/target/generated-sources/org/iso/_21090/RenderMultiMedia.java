...
public class RenderMultiMedia {
    ...
    public RenderMultiMedia withCaption(Caption value) {
        setCaption(value);
        return this;
    }

    public RenderMultiMedia withReferencedObject(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getReferencedObject().add(value);
            }
        }
        return this;
    }

    public RenderMultiMedia withReferencedObject(Collection<Object> values) {
        if (values!= null) {
            getReferencedObject().addAll(values);
        }
        return this;
    }

    public RenderMultiMedia withID(String value) {
        setID(value);
        return this;
    }

    public RenderMultiMedia withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public RenderMultiMedia withStyleCode(String... values) {
        if (values!= null) {
    ...
    public RenderMultiMedia withStyleCode(Collection<String> values) {
        if (values!= null) {
