    ...
    extends QSETTSDateTime
{
    ...
    public IVLTSDateTime withLow(TSDateTime value) {
        setLow(value);
        return this;
    }

    public IVLTSDateTime withHigh(TSDateTime value) {
        setHigh(value);
        return this;
    }

    public IVLTSDateTime withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLTSDateTime withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLTSDateTime withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLTSDateTime withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLTSDateTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLTSDateTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLTSDateTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLTSDateTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLTSDateTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLTSDateTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLTSDateTime withControlActExtension(String value) {
