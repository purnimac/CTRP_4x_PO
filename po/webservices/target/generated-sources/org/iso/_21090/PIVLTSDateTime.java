    ...
    extends QSETTSDateTime
{
    ...
    public PIVLTSDateTime withPhase(IVLTSDateTime value) {
        setPhase(value);
        return this;
    }

    public PIVLTSDateTime withPeriod(PQ value) {
        setPeriod(value);
        return this;
    }

    public PIVLTSDateTime withAlignment(CalendarCycle value) {
        setAlignment(value);
        return this;
    }

    public PIVLTSDateTime withInstitutionSpecified(Boolean value) {
        setInstitutionSpecified(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public PIVLTSDateTime withControlActExtension(String value) {
