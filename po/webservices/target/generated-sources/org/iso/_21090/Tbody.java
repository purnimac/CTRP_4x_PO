...
public class Tbody {
    ...
    public Tbody withTr(Collection<Tr> values) {
        if (values!= null) {
            getTr().addAll(values);
        }
        return this;
    ...
    public Tbody withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Tbody withStyleCode(Collection<String> values) {
        if (values!= null) {
