...
public class Caption {
    ...
    public Caption withContent(Object... values) {
        if (values!= null) {
    ...
    public Caption withContent(Collection<Object> values) {
        if (values!= null) {
    ...
    public Caption withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Caption withStyleCode(Collection<String> values) {
        if (values!= null) {
