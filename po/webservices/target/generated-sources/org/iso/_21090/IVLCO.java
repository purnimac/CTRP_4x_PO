    ...
    extends QSETCO
{
    ...
    public IVLCO withLow(CO value) {
        setLow(value);
        return this;
    }

    public IVLCO withHigh(CO value) {
        setHigh(value);
        return this;
    }

    public IVLCO withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLCO withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLCO withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLCO withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLCO withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLCO withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLCO withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLCO withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLCO withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLCO withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLCO withControlActExtension(String value) {
