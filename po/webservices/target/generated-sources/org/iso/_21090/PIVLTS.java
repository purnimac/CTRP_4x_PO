    ...
    extends QSETTS
{
    ...
    public PIVLTS withAlignment(CalendarCycle value) {
        setAlignment(value);
        return this;
    }
    ...
    @Override
    public PIVLTS withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public PIVLTS withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public PIVLTS withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public PIVLTS withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public PIVLTS withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public PIVLTS withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public PIVLTS withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public PIVLTS withControlActExtension(String value) {
