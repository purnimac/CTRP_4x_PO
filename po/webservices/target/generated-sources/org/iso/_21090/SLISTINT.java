    ...
    extends ANY
{
    ...
    public SLISTINT withOrigin(INT value) {
        setOrigin(value);
        return this;
    }

    public SLISTINT withScale(QTY value) {
        setScale(value);
        return this;
    }

    public SLISTINT withDigit(INT... values) {
        if (values!= null) {
    ...
    public SLISTINT withDigit(Collection<INT> values) {
        if (values!= null) {
    ...
    @Override
    public SLISTINT withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public SLISTINT withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public SLISTINT withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public SLISTINT withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public SLISTINT withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public SLISTINT withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public SLISTINT withControlActExtension(String value) {
