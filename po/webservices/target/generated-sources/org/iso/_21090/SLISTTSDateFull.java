    ...
    extends ANY
{
    ...
    public SLISTTSDateFull withOrigin(TSDateFull value) {
        setOrigin(value);
        return this;
    }

    public SLISTTSDateFull withScale(QTY value) {
        setScale(value);
        return this;
    }

    public SLISTTSDateFull withDigit(INT... values) {
        if (values!= null) {
    ...
    public SLISTTSDateFull withDigit(Collection<INT> values) {
        if (values!= null) {
    ...
    @Override
    public SLISTTSDateFull withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public SLISTTSDateFull withControlActExtension(String value) {
