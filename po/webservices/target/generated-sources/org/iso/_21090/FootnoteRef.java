...
public class FootnoteRef {
    ...
    public FootnoteRef withID(String value) {
        setID(value);
        return this;
    }

    public FootnoteRef withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public FootnoteRef withStyleCode(String... values) {
        if (values!= null) {
    ...
    public FootnoteRef withStyleCode(Collection<String> values) {
        if (values!= null) {
    ...
    public FootnoteRef withIDREF(Object value) {
        setIDREF(value);
        return this;
    }
