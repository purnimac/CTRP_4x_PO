    ...
    extends ANY
{
    ...
    public GLISTTSDateFull withHead(TSDateFull value) {
        setHead(value);
        return this;
    }

    public GLISTTSDateFull withIncrement(QTY value) {
        setIncrement(value);
        return this;
    }

    public GLISTTSDateFull withDenominator(Integer value) {
        setDenominator(value);
        return this;
    }

    public GLISTTSDateFull withPeriod(Integer value) {
        setPeriod(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public GLISTTSDateFull withControlActExtension(String value) {
