...
public class Th {
    ...
    public Th withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Th withStyleCode(Collection<String> values) {
        if (values!= null) {
    ...
    public Th withScope(String value) {
        setScope(value);
        return this;
    }

    public Th withRowspan(String value) {
        setRowspan(value);
        return this;
    }

    public Th withColspan(String value) {
        setColspan(value);
        return this;
    }
