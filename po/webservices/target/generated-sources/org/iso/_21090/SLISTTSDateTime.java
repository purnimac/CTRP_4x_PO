    ...
    extends ANY
{
    ...
    public SLISTTSDateTime withOrigin(TSDateTime value) {
        setOrigin(value);
        return this;
    }

    public SLISTTSDateTime withScale(QTY value) {
        setScale(value);
        return this;
    }

    public SLISTTSDateTime withDigit(INT... values) {
        if (values!= null) {
    ...
    public SLISTTSDateTime withDigit(Collection<INT> values) {
        if (values!= null) {
    ...
    @Override
    public SLISTTSDateTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public SLISTTSDateTime withControlActExtension(String value) {
