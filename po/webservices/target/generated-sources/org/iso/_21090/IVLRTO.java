    ...
    extends QSETRTO
{
    ...
    public IVLRTO withLow(RTO value) {
        setLow(value);
        return this;
    }

    public IVLRTO withHigh(RTO value) {
        setHigh(value);
        return this;
    }

    public IVLRTO withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLRTO withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLRTO withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLRTO withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLRTO withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLRTO withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLRTO withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLRTO withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLRTO withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLRTO withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLRTO withControlActExtension(String value) {
