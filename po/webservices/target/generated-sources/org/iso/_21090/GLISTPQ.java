    ...
    extends ANY
{
    ...
    public GLISTPQ withIncrement(QTY value) {
        setIncrement(value);
        return this;
    }

    public GLISTPQ withDenominator(Integer value) {
        setDenominator(value);
        return this;
    }

    public GLISTPQ withPeriod(Integer value) {
        setPeriod(value);
        return this;
    }

    @Override
    public GLISTPQ withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public GLISTPQ withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public GLISTPQ withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public GLISTPQ withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public GLISTPQ withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public GLISTPQ withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public GLISTPQ withControlActExtension(String value) {
