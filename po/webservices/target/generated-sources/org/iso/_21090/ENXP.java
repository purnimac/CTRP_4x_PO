...
public class ENXP {
    ...
    public ENXP withValue(String value) {
        setValue(value);
        return this;
    }

    public ENXP withCode(String value) {
        setCode(value);
        return this;
    }

    public ENXP withCodeSystem(String value) {
        setCodeSystem(value);
        return this;
    }

    public ENXP withCodeSystemVersion(String value) {
        setCodeSystemVersion(value);
        return this;
    }

    public ENXP withType(EntityNamePartType value) {
        setType(value);
        return this;
    }

    public ENXP withQualifier(EntityNamePartQualifier... values) {
        if (values!= null) {
            for (EntityNamePartQualifier value: values) {
    ...
    public ENXP withQualifier(Collection<EntityNamePartQualifier> values) {
        if (values!= null) {
