...
public class Colgroup {
    ...
    public Colgroup withCol(Col... values) {
        if (values!= null) {
    ...
    public Colgroup withCol(Collection<Col> values) {
        if (values!= null) {
    ...
    public Colgroup withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Colgroup withStyleCode(Collection<String> values) {
        if (values!= null) {
    ...
    public Colgroup withSpan(String value) {
        setSpan(value);
        return this;
    }
