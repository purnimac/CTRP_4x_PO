    ...
    extends QSETPQTime
{
    ...
    public IVLPQTime withLow(PQTime value) {
        setLow(value);
        return this;
    }

    public IVLPQTime withHigh(PQTime value) {
        setHigh(value);
        return this;
    }

    public IVLPQTime withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLPQTime withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLPQTime withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLPQTime withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLPQTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLPQTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLPQTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLPQTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLPQTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLPQTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLPQTime withControlActExtension(String value) {
