...
public class Thead {
    ...
    public Thead withTr(Collection<Tr> values) {
        if (values!= null) {
            getTr().addAll(values);
        }
        return this;
    ...
    public Thead withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Thead withStyleCode(Collection<String> values) {
        if (values!= null) {
