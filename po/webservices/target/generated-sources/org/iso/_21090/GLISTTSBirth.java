    ...
    extends ANY
{
    ...
    public GLISTTSBirth withHead(TSBirth value) {
        setHead(value);
        return this;
    }

    public GLISTTSBirth withIncrement(QTY value) {
        setIncrement(value);
        return this;
    }

    public GLISTTSBirth withDenominator(Integer value) {
        setDenominator(value);
        return this;
    }

    public GLISTTSBirth withPeriod(Integer value) {
        setPeriod(value);
        return this;
    }

    @Override
    public GLISTTSBirth withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public GLISTTSBirth withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public GLISTTSBirth withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public GLISTTSBirth withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public GLISTTSBirth withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public GLISTTSBirth withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public GLISTTSBirth withControlActExtension(String value) {
