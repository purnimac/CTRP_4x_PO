    ...
    extends ANY
{
    ...
    public SLISTTS withScale(QTY value) {
        setScale(value);
        return this;
    }

    public SLISTTS withDigit(INT... values) {
        if (values!= null) {
    ...
    public SLISTTS withDigit(Collection<INT> values) {
        if (values!= null) {
    ...
    @Override
    public SLISTTS withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public SLISTTS withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public SLISTTS withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public SLISTTS withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public SLISTTS withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public SLISTTS withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public SLISTTS withControlActExtension(String value) {
