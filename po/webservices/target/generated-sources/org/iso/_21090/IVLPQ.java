    ...
    extends QSETPQ
{
    ...
    public IVLPQ withLow(PQ value) {
        setLow(value);
        return this;
    }

    public IVLPQ withHigh(PQ value) {
        setHigh(value);
        return this;
    }

    public IVLPQ withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLPQ withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLPQ withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLPQ withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLPQ withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLPQ withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLPQ withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLPQ withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLPQ withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLPQ withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLPQ withControlActExtension(String value) {
