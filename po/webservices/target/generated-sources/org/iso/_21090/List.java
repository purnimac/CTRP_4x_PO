...
public class List {
    ...
    public List withCaption(Caption value) {
        setCaption(value);
        return this;
    }

    public List withItem(Item... values) {
        if (values!= null) {
    ...
    public List withItem(Collection<Item> values) {
        if (values!= null) {
    ...
    public List withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public List withStyleCode(String... values) {
        if (values!= null) {
    ...
    public List withStyleCode(Collection<String> values) {
        if (values!= null) {
    ...
    public List withListType(String value) {
        setListType(value);
        return this;
    }
