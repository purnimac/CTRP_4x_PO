    ...
    extends QSETTSDate
{
    ...
    public PIVLTSDate withPhase(IVLTSDate value) {
        setPhase(value);
        return this;
    }

    public PIVLTSDate withPeriod(PQ value) {
        setPeriod(value);
        return this;
    }

    public PIVLTSDate withAlignment(CalendarCycle value) {
        setAlignment(value);
        return this;
    }

    public PIVLTSDate withInstitutionSpecified(Boolean value) {
        setInstitutionSpecified(value);
        return this;
    }

    @Override
    public PIVLTSDate withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public PIVLTSDate withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public PIVLTSDate withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public PIVLTSDate withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public PIVLTSDate withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public PIVLTSDate withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public PIVLTSDate withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public PIVLTSDate withControlActExtension(String value) {
