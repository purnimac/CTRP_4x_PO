    ...
    extends QSETINT
{
    ...
    public IVLINT withLow(INT value) {
        setLow(value);
        return this;
    }

    public IVLINT withHigh(INT value) {
        setHigh(value);
        return this;
    }

    public IVLINT withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLINT withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLINT withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLINT withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLINT withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLINT withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLINT withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLINT withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLINT withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLINT withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLINT withControlActExtension(String value) {
