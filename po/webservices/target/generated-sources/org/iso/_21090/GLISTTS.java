    ...
    extends ANY
{
    ...
    public GLISTTS withHead(TS value) {
        setHead(value);
        return this;
    }

    public GLISTTS withIncrement(QTY value) {
        setIncrement(value);
        return this;
    }

    public GLISTTS withDenominator(Integer value) {
        setDenominator(value);
        return this;
    }

    public GLISTTS withPeriod(Integer value) {
        setPeriod(value);
        return this;
    }

    @Override
    public GLISTTS withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public GLISTTS withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public GLISTTS withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public GLISTTS withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public GLISTTS withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public GLISTTS withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public GLISTTS withControlActExtension(String value) {
