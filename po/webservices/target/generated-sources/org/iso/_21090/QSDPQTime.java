    ...
    extends QSETPQTime
{
    ...
    public QSDPQTime withFirst(QSETPQTime value) {
        setFirst(value);
        return this;
    }

    public QSDPQTime withSecond(QSETPQTime value) {
        setSecond(value);
        return this;
    }

    @Override
    public QSDPQTime withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public QSDPQTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public QSDPQTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public QSDPQTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public QSDPQTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public QSDPQTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public QSDPQTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public QSDPQTime withControlActExtension(String value) {
