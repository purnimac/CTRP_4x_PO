    ...
    extends QSETTSDateTimeFull
{
    ...
    public IVLTSDateTimeFull withLow(TSDateTimeFull value) {
        setLow(value);
        return this;
    }

    public IVLTSDateTimeFull withHigh(TSDateTimeFull value) {
        setHigh(value);
        return this;
    }

    public IVLTSDateTimeFull withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLTSDateTimeFull withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLTSDateTimeFull withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLTSDateTimeFull withControlActExtension(String value) {
