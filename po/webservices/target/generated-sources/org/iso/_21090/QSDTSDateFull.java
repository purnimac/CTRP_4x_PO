    ...
    extends QSETTSDateFull
{
    ...
    public QSDTSDateFull withFirst(QSETTSDateFull value) {
        setFirst(value);
        return this;
    }

    public QSDTSDateFull withSecond(QSETTSDateFull value) {
        setSecond(value);
        return this;
    }

    @Override
    public QSDTSDateFull withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public QSDTSDateFull withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public QSDTSDateFull withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public QSDTSDateFull withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public QSDTSDateFull withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public QSDTSDateFull withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public QSDTSDateFull withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public QSDTSDateFull withControlActExtension(String value) {
