    ...
    extends QSETTSDateFull
{
    ...
    public PIVLTSDateFull withPhase(IVLTSDateFull value) {
        setPhase(value);
        return this;
    }

    public PIVLTSDateFull withPeriod(PQ value) {
        setPeriod(value);
        return this;
    }

    public PIVLTSDateFull withAlignment(CalendarCycle value) {
        setAlignment(value);
        return this;
    }

    public PIVLTSDateFull withInstitutionSpecified(Boolean value) {
        setInstitutionSpecified(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public PIVLTSDateFull withControlActExtension(String value) {
