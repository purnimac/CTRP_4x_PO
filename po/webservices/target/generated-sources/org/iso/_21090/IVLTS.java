    ...
    extends QSETTS
{
    ...
    public IVLTS withLow(TS value) {
        setLow(value);
        return this;
    }

    public IVLTS withHigh(TS value) {
        setHigh(value);
        return this;
    }

    public IVLTS withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLTS withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLTS withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLTS withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLTS withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLTS withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLTS withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLTS withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLTS withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLTS withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLTS withControlActExtension(String value) {
