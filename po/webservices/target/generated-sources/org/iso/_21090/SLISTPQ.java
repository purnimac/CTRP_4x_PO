    ...
    extends ANY
{
    ...
    public SLISTPQ withOrigin(PQ value) {
        setOrigin(value);
        return this;
    }

    public SLISTPQ withScale(QTY value) {
        setScale(value);
        return this;
    }

    public SLISTPQ withDigit(INT... values) {
        if (values!= null) {
    ...
    public SLISTPQ withDigit(Collection<INT> values) {
        if (values!= null) {
    ...
    @Override
    public SLISTPQ withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public SLISTPQ withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public SLISTPQ withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public SLISTPQ withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public SLISTPQ withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public SLISTPQ withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public SLISTPQ withControlActExtension(String value) {
