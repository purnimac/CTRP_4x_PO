...
public class Footnote {
    ...
    public Footnote withContent(Object... values) {
        if (values!= null) {
    ...
    public Footnote withContent(Collection<Object> values) {
        if (values!= null) {
    ...
    public Footnote withID(String value) {
        setID(value);
        return this;
    }

    public Footnote withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public Footnote withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Footnote withStyleCode(Collection<String> values) {
        if (values!= null) {
