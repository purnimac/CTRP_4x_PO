...
public class Paragraph {
    ...
    public Paragraph withContent(Object... values) {
        if (values!= null) {
    ...
    public Paragraph withContent(Collection<Object> values) {
        if (values!= null) {
    ...
    public Paragraph withID(String value) {
        setID(value);
        return this;
    }

    public Paragraph withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public Paragraph withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Paragraph withStyleCode(Collection<String> values) {
        if (values!= null) {
