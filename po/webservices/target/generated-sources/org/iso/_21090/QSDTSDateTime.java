    ...
    extends QSETTSDateTime
{
    ...
    public QSDTSDateTime withFirst(QSETTSDateTime value) {
        setFirst(value);
        return this;
    }

    public QSDTSDateTime withSecond(QSETTSDateTime value) {
        setSecond(value);
        return this;
    }

    @Override
    public QSDTSDateTime withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public QSDTSDateTime withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public QSDTSDateTime withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public QSDTSDateTime withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public QSDTSDateTime withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public QSDTSDateTime withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public QSDTSDateTime withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public QSDTSDateTime withControlActExtension(String value) {
