    ...
    extends QSETREAL
{
    ...
    public IVLREAL withLow(REAL value) {
        setLow(value);
        return this;
    }

    public IVLREAL withHigh(REAL value) {
        setHigh(value);
        return this;
    }

    public IVLREAL withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLREAL withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLREAL withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLREAL withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLREAL withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLREAL withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLREAL withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLREAL withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLREAL withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLREAL withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLREAL withControlActExtension(String value) {
