    ...
    extends QSETMO
{
    ...
    public IVLMO withLow(MO value) {
        setLow(value);
        return this;
    }

    public IVLMO withHigh(MO value) {
        setHigh(value);
        return this;
    }

    public IVLMO withWidth(QTY value) {
        setWidth(value);
        return this;
    }

    public IVLMO withLowClosed(Boolean value) {
        setLowClosed(value);
        return this;
    }

    public IVLMO withHighClosed(Boolean value) {
        setHighClosed(value);
        return this;
    }

    @Override
    public IVLMO withOriginalText(EDText value) {
        setOriginalText(value);
        return this;
    }

    @Override
    public IVLMO withNullFlavor(NullFlavor value) {
        setNullFlavor(value);
        return this;
    }

    @Override
    public IVLMO withFlavorId(String value) {
        setFlavorId(value);
        return this;
    }

    @Override
    public IVLMO withUpdateMode(UpdateMode value) {
        setUpdateMode(value);
        return this;
    }

    @Override
    public IVLMO withValidTimeLow(String value) {
        setValidTimeLow(value);
        return this;
    }

    @Override
    public IVLMO withValidTimeHigh(String value) {
        setValidTimeHigh(value);
        return this;
    }

    @Override
    public IVLMO withControlActRoot(String value) {
        setControlActRoot(value);
        return this;
    }

    @Override
    public IVLMO withControlActExtension(String value) {
