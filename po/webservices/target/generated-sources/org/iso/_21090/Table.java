...
public class Table {
    ...
    public Table withCol(Collection<Col> values) {
        if (values!= null) {
    ...
    public Table withColgroup(Collection<Colgroup> values) {
        if (values!= null) {
    ...
    public Table withTbody(Collection<Tbody> values) {
        if (values!= null) {
    ...
    public Table withStyleCode(String... values) {
        if (values!= null) {
    ...
    public Table withStyleCode(Collection<String> values) {
        if (values!= null) {
    ...
    public Table withFrame(String value) {
        setFrame(value);
        return this;
    }

    public Table withRules(String value) {
        setRules(value);
        return this;
    }
