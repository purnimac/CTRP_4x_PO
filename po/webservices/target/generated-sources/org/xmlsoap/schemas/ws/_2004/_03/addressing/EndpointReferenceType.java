...
public class EndpointReferenceType {
    ...
    public EndpointReferenceType withAddress(AttributedURI value) {
        setAddress(value);
        return this;
    }

    public EndpointReferenceType withReferenceProperties(ReferencePropertiesType value) {
        setReferenceProperties(value);
        return this;
    }

    public EndpointReferenceType withPortType(AttributedQName value) {
        setPortType(value);
        return this;
    }

    public EndpointReferenceType withServiceName(ServiceNameType value) {
        setServiceName(value);
        return this;
    }

    public EndpointReferenceType withAny(Object... values) {
        if (values!= null) {
    ...
    public EndpointReferenceType withAny(Collection<Object> values) {
        if (values!= null) {
