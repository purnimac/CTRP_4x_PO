 ...
 * 
 * This is the helper class for the gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO snapshot class.
 */
...
public class AbstractIdentifiedOrganizationDTOHelper implements SnapshotHelper {
  /**
  ...
  public Object createSnapshot(Object model, TransformContext context) throws XSnapshotException {
    if (model == null) {
      ...
      Class myClass = gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization.class;
      if (myClass.isInstance (model)) {
        ...
        throw new IllegalStateException ("Concrete instance of an abstract class found, or helper called directly");
         ...
         throw new IllegalArgumentException ("model object is of class " + model.getClass () + " which is not a subclass of gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization");
      }
    }
  }
  /**
  ...
  public Object createModel(Object snapshot, TransformContext context) throws XSnapshotException {
    if (snapshot == null) {
      ...
      Class myClass = gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO.class;
      if (myClass.isInstance (snapshot)) {
        ...
        throw new IllegalStateException ("Concrete instance of an abstract class found, or helper called directly");
         ...
         throw new IllegalArgumentException ("snapshot object is of class " + snapshot.getClass () + " which is not a subclass of gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO");
      }
    }     
  }

  /**
    * Copies a gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization model object into a gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO snapshot object
  ...
  public void copyIntoSnapshot (Object model, Object snapshot, TransformContext context) throws XSnapshotException {
    ...
    gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO snapshotCasted = (gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO) snapshot;
    gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization modelCasted = (gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization) model;

    gov.nih.nci.po.data.bo.Organization modelValPlayerIdentifier = modelCasted.getPlayer ();

    copyModelToSnapshotPlayerIdentifier (modelValPlayerIdentifier, snapshotCasted, context);
  }
  /**
    * Copies a XDtXSnapshot:snapshotClass/> snapshot object into a gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization  model object
  ...
  public void copyIntoModel(Object snapshot, Object model, TransformContext context) throws XSnapshotException {
    ...
    */
  protected void copyModelToSnapshotPlayerIdentifier (gov.nih.nci.po.data.bo.Organization modelVal, gov.nih.nci.services.correlation.AbstractIdentifiedOrganizationDTO snapshot, TransformContext context) {
    ...
    */    
  protected void copySnapshotToModelPlayerIdentifier (gov.nih.nci.iso21090.Ii snapshotVal, gov.nih.nci.po.data.bo.AbstractIdentifiedOrganization model, TransformContext context) {

    gov.nih.nci.po.data.bo.Organization modelVal = model.getPlayer ();
