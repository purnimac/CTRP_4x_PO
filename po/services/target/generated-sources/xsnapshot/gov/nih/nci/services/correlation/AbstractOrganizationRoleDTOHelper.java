 ...
 * 
 * This is the helper class for the gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO snapshot class.
 */
...
public class AbstractOrganizationRoleDTOHelper implements SnapshotHelper {
  ...
  public Object createSnapshot(Object model, TransformContext context) throws XSnapshotException {
    if (model == null) {
      ...
      Class myClass = gov.nih.nci.po.data.bo.AbstractOrganizationRole.class;
      if (myClass.isInstance (model)) {
        ...
        throw new IllegalStateException ("Concrete instance of an abstract class found, or helper called directly");
         ...
         throw new IllegalArgumentException ("model object is of class " + model.getClass () + " which is not a subclass of gov.nih.nci.po.data.bo.AbstractOrganizationRole");
      }
    }
  }
  /**
  ...
  public Object createModel(Object snapshot, TransformContext context) throws XSnapshotException {
    if (snapshot == null) {
      ...
      Class myClass = gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO.class;
      if (myClass.isInstance (snapshot)) {
        ...
        throw new IllegalStateException ("Concrete instance of an abstract class found, or helper called directly");
         ...
         throw new IllegalArgumentException ("snapshot object is of class " + snapshot.getClass () + " which is not a subclass of gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO");
      }
    }     
  }

  /**
    * Copies a gov.nih.nci.po.data.bo.AbstractOrganizationRole model object into a gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO snapshot object
  ...
  public void copyIntoSnapshot (Object model, Object snapshot, TransformContext context) throws XSnapshotException {
    ...
    gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO snapshotCasted = (gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO) snapshot;
    gov.nih.nci.po.data.bo.AbstractOrganizationRole modelCasted = (gov.nih.nci.po.data.bo.AbstractOrganizationRole) model;
  ...
  /**
    * Copies a XDtXSnapshot:snapshotClass/> snapshot object into a gov.nih.nci.po.data.bo.AbstractOrganizationRole  model object
  ...
  public void copyIntoModel(Object snapshot, Object model, TransformContext context) throws XSnapshotException {
    ...
    */
  protected void copyModelToSnapshotPlayerIdentifier (gov.nih.nci.po.data.bo.Organization modelVal, gov.nih.nci.services.correlation.AbstractOrganizationRoleDTO snapshot, TransformContext context) {
    ...
    */    
  protected void copySnapshotToModelPlayerIdentifier (gov.nih.nci.iso21090.Ii snapshotVal, gov.nih.nci.po.data.bo.AbstractOrganizationRole model, TransformContext context) {
