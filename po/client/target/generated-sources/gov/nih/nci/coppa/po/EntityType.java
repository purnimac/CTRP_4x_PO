...
public class EntityType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Person", namespace = "http://po.coppa.nci.nih.gov", type = Person.class),
        @XmlElementRef(name = "Organization", namespace = "http://po.coppa.nci.nih.gov", type = Organization.class)
    })
    @XmlMixed
